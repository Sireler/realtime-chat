...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand chat-link" href="{{ url('/chat') }}">
                    Chat
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <span style="margin-right: 20px;" class="chat-img ">
                                <img id="currUserAvatar" src="{{ asset(Auth::user()->avatar) }}" alt="User Avatar" class="rounded-circle">
                            </span>
